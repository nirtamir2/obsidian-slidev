# First-run Slidev onboarding checklist

- [x] Task 1: Diagnose Node.js and locate npm without a shell.
- [x] Task 2: Create, install, verify, and cancel the starter project.
- [x] Checkpoint: Run foundation tests and security review.
